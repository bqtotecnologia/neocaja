<?php
// El modelo base que contiene los métodos fundamentales para manejo de bases de datos con PostgreSQL
...
class PGSQLModel{
    ...
    {   
        $my_string = 'pgsql:host='.$this->db_server.';dbname='.$this->db_database;
