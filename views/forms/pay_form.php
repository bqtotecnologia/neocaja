...
<main class="row col-12 m-0 p-0 justify-content-center align-items-start">
    <div class="x_panel row col-12 m-0 p-2">
        ...
        <section class="row col-12 col-lg-8 m-0 p-1 justify-content-center align-items-start">
            <div class="col-12 text-center border border-black rounded">
                ...
                <div class="row m-0 p-0 my-3 col-12 justify-content-start align-items-start flex-wrap">
                    <?php foreach($products as $product) { ?>
                        <article class="row m-0 p-2 col-4 col-lg-3 align-self-stretch">
                            <div class="w-100 border border-black rounded product-card text-black p-2" id="<?= $product['code'] ?>" onclick="SelectProduct(this)">
                                <h6 class="h5 fw-bold col-12 text-center"><?= $product['name'] ?></h6>
        ...
        <section class="row col-12 col-lg-4 m-0 p-1 justify-content-center align-items-start">
            <div class="row col-12 justify-content-center align-items-start">
                <table class="w-100 h6 text-black">
                    <thead>
